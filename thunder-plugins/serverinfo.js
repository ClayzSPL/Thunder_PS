...
exports.commands = {
	...
	customcommands: function () {
		...
		display += `<li><a href="https://discord.gg/Csvd4nK" target="_blank"><button style="cursor: url(&quot;&quot;), auto;">Discord</button></a>`;
		display += `<li><a href="http://exiledps.boards.net/" target="_blank"><button style="cursor: url(&quot;&quot;), auto;">Forums</button></a>`;
		display += `<li><a href="https://github.com/BnaeOfAll/LightVoid" target="_blank"><button style="cursor: url(&quot;&quot;), auto;">GitHub</button></a>`;
