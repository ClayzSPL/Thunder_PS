...
function getShopDisplay(shop) {
	let display = `<center><psicon pokemon="kyurem-black"><img src="https://images.cooltext.com/5068029.png"><psicon pokemon="kyurem-black"></center><br><div" + (!this.isOfficial ? ' class=infobox-limited' : '') + "><table style="background: #e60073; border-color: #000; border-radius: 6px" border="1" cellspacing="0" cellpadding="5" width="100%">` +
